...
namespace Cineverse.Notifications.Common.Helpers;
...
internal static class NotificationTemplateHelper
{
    ...
    public static string BuildTemplate(MessageBuilder message)
    {
        return TemplateContent.Replace(ContentKey, message.Build());
    }
