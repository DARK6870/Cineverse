...
using Cineverse.Api.GraphQl.Middlewares.StatusCodeMiddleware.Models;
using Cineverse.Infrastructure.Common.Configurations;

namespace Cineverse.Api.GraphQl.Middlewares.StatusCodeMiddleware;
...
)
{
    ...
    public async Task InvokeAsync(HttpContext context)
    {
        ...
        var errorsPattern = "\"errors\""u8.ToArray();
